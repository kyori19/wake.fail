 ...
 */
export const getThemeClasses = (theme: ProgressTheme, isComplete: boolean = false) => {
  switch (theme) {
    case 'windowsXP':
      return {
        container: 'bg-blue-100 border-2 border-blue-300 rounded-sm shadow-inner',
        bar: isComplete 
    ...
    case 'windows98':
      return {
        container: 'bg-gray-300 border-2 border-t-white border-l-white border-r-gray-600 border-b-gray-600',
        bar: isComplete
